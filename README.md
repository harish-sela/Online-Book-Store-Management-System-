...
- User Login Credentials: (Harish/Harish)
...
insert into users values('Harish','Harish','Harish','Harish','Andhra Pradesh','1236547089','harishsela56@gmail.com',2);
...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/harish-sela/Online-Book-Store-Management-System-```> Select master Branch > Next > Next > Finish.
...
Step 8: The default Username And Password For User Is "Harish" And "Harish"
